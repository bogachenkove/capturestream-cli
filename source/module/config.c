...
configuration_manager* configuration_create(const char *path)
{
    ...
    strncpy(manager->current_configuration.configuration_path,
            path, sizeof(manager->current_configuration.configuration_path) - 1);
    manager->current_configuration.configuration_path[
            sizeof(manager->current_configuration.configuration_path) - 1] = '\0';
...
int configuration_reload(configuration_manager *manager)
{
    ...
    if (config_parser_load(manager->current_configuration.configuration_path,
                           &new_config) != 0)
    {
...
int configuration_set_int(configuration_manager *manager, const char *key, int value)
{
    ...
    if (strcmp(key, "segment_duration_seconds") == 0) { target_configuration->segment_duration_seconds = value; match_found = 1; }
    else if (strcmp(key, "failure_cooldown_seconds") == 0) { target_configuration->failure_cooldown_seconds = value; match_found = 1; }
    else if (strcmp(key, "stream_timeout_seconds") == 0) { target_configuration->stream_timeout_seconds = value; match_found = 1; }
    else if (strcmp(key, "retry_streams_seconds") == 0) { target_configuration->retry_streams_seconds = value; match_found = 1; }
    else if (strcmp(key, "retry_open_attempts") == 0) { target_configuration->retry_open_attempts = value; match_found = 1; }
    else if (strcmp(key, "disk_free_percent_limit") == 0) { target_configuration->disk_free_percent_limit = value; match_found = 1; }
    else if (strcmp(key, "disk_free_absolute_limit_gb") == 0) { target_configuration->disk_free_absolute_limit_gb = value; match_found = 1; }
    else if (strcmp(key, "disk_check_interval_seconds") == 0) { target_configuration->disk_check_interval_seconds = value; match_found = 1; }
    else if (strcmp(key, "memory_check_interval_seconds") == 0) { target_configuration->memory_check_interval_seconds = value; match_found = 1; }
    else if (strcmp(key, "memory_warning_percent") == 0) { target_configuration->memory_warning_percent = value; match_found = 1; }
    else if (strcmp(key, "memory_critical_percent") == 0) { target_configuration->memory_critical_percent = value; match_found = 1; }
    else if (strcmp(key, "memory_warning_mb") == 0) { target_configuration->memory_warning_mb = value; match_found = 1; }
    else if (strcmp(key, "memory_critical_mb") == 0) { target_configuration->memory_critical_mb = value; match_found = 1; }
    else if (strcmp(key, "subprocess_rss_limit_mb") == 0) { target_configuration->subprocess_rss_limit_mb = value; match_found = 1; }
    else if (strcmp(key, "buffer_max_size_mb") == 0) { target_configuration->buffer_max_size_mb = value; match_found = 1; }
    else if (strcmp(key, "log_level") == 0) { target_configuration->log_level = value; match_found = 1; }
    else if (strcmp(key, "concat_max_size_mb") == 0) { target_configuration->concat_max_size_mb = value; match_found = 1; }
    else if (strcmp(key, "concat_keep_ts") == 0) { target_configuration->concat_keep_ts = value; match_found = 1; }
    else if (strcmp(key, "concat_scan_interval_seconds") == 0) { target_configuration->concat_scan_interval_seconds = value; match_found = 1; }
    else if (strcmp(key, "concat_force_on_low_disk") == 0) { target_configuration->concat_force_on_low_disk = value; match_found = 1; }
    else if (strcmp(key, "max_mp4_files_to_keep") == 0) { target_configuration->max_mp4_files_to_keep = value; match_found = 1; }
