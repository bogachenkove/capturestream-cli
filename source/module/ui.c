...
static void* ui_thread_function(void *argument)
{
    ...
    while (ui_running_flag)
    {
        ...
        printf("\033[H");
        printf("\033[K\033[1;37m=== Stream Recorder Status ===\033[0m\n");
        ...
        if (recorder_count == 0)
        {
            printf("\033[KNo streamers configured.\n");
        }
        else
        {
